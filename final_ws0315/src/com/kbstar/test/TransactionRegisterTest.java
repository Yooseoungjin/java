...
public class TransactionRegisterTest {
	...
	public static void main(String[] args) {
		...
		TransactionDTO obj = new TransactionDTO(MakeAccountNumber.makeTrNum(), "20230309100", 500, "O", "국민카드");
		TransactionDTO obj2 = new TransactionDTO(MakeAccountNumber.makeTrNum(), "20230309100", 600, "O", "국민카드");
		TransactionDTO obj3 = new TransactionDTO(MakeAccountNumber.makeTrNum(), "20230309100", 700, "O", "국민카드");
